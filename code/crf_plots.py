...
wt = np.loadtxt('../result/crf_wts_c1.txt')
l, w = crf_test(wt, test_data)
#t = wt[-26*26:].T.reshape(-1)
#wt[-26*26:] = t
#np.savetxt("../result/crf_wts_c1.txt", wt)
...
wt = np.loadtxt('../result/crf_wts_c50.txt')
l, w = crf_test(wt, test_data)
#t = wt[-26*26:].T.reshape(-1)
#wt[-26*26:] = t
#np.savetxt("../result/crf_wts_c50.txt", wt)
ls.append(l)
ws.append(w)

#wt = crf_optimize(train_data, test_data, 350)
wt = np.loadtxt('../result/crf_wts_c350.txt')
l, w = crf_test(wt, test_data)
#t = wt[-26*26:].T.reshape(-1)
#wt[-26*26:] = t
#np.savetxt("../result/crf_wts_c350.txt", wt)
ls.append(l)
ws.append(w)
